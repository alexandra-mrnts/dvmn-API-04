...
def fetch_NASA_EPIC_images(max_pics_number, storage_dir, api_key):
    ...
    for image_number, image in enumerate(response_body, start=1):
        ...
        filepath = storage_dir.joinpath(f'nasa_EPIC_{image_number}.png')
        load_image(url=image_url, query_params=params, filepath=filepath)
...
def main():
    ...
    max_pics_number = args.pics_number
